      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        <div className="bg-white rounded-3xl p-6 border border-[#E8E2D8] shadow-sm">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-sm text-[#8B8B8B]">Account information</p>
            </div>
          </div>
        ...
        <div className="bg-white rounded-3xl p-6 border border-[#E8E2D8] shadow-sm">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-sm text-[#8B8B8B]">Notification & automation</p>
            </div>
          </div>
            ...
            <label className="flex items-center justify-between cursor-pointer">
              <div>
                ...
                <p className="text-xs text-[#8B8B8B]">
                  Get alerts when receipts are processed
                </p>
              </div>
              <input
                type="checkbox"
        ...
        <div className="lg:col-span-2 bg-white rounded-3xl p-6 border border-[#E8E2D8] shadow-sm">
          ...
          <p className="text-sm text-[#6B6B6B] leading-relaxed">
            Expensify AI uses JWT authentication and secure API endpoints. Receipt
            images are stored locally on the server and linked to your account only.
          </p>
        </div>
      </div>
    </div>
